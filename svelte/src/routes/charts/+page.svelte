					...
					<div class="flex flex-col">
						<div class="pb-2">
							...
							<input
								bind:value={limit}
								type="number"
								class="inline-flex justify-center mb-2 rounded-lg bg-slate-700 border-slate-200 text-md text-white focus:outline-none px-3 w-24"
							/>
						</div>
						<input
							id="limit-range"
						...
						<div class="pb-2">
							...
							<input
								bind:value={offset}
								type="number"
								class="inline-flex mb-2 text-md border-none bg-slate-700 rounded-lg text-white focus:outline-none px-3 w-24"
							/>
						</div>
						<input
							id="offset-range"
